...
/**
 * Created by zhang on 2017/6/23 11 : 27.
 */
...
public class MyRelativeLayout extends RelativeLayout {
    ...
    public MyRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        init();
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MyRelativeLayout, defStyleAttr,0);
        aBoolean = a.getBoolean(R.styleable.MyRelativeLayout_rl_control_adapter, false);
        control_width = a.getInteger(R.styleable.MyRelativeLayout_rl_control_width, 0);
        control_height = a.getInteger(R.styleable.MyRelativeLayout_rl_control_height, 0);
        margin = a.getInteger(R.styleable.MyRelativeLayout_rl_margin, 0);
        margin_left = a.getInteger(R.styleable.MyRelativeLayout_rl_margin_left, 0);
        margin_top = a.getInteger(R.styleable.MyRelativeLayout_rl_margin_top, 0);
        margin_right = a.getInteger(R.styleable.MyRelativeLayout_rl_margin_right, 0);
        margin_bottom = a.getInteger(R.styleable.MyRelativeLayout_rl_margin_bottom, 0);
        a.recycle();
    }
