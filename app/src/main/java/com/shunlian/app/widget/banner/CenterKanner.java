...
public class CenterKanner extends BaseBanner<String, CenterKanner> {
    public CenterKanner(Context context) {
        this(context, null, 0);
    }


    public CenterKanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CenterKanner(Context context, AttributeSet attrs, int defStyle) {
...
//        GlideUtils.getInstance().communityBanner(context,iv,list.get(position));
        ...
        GlideUtils.getInstance().loadOverrideImage(context,iv,list.get(position),deviceWidth,(int)(deviceWidth*scale),6);
