...
public abstract class MonthView extends BaseView {
    ...
    private void draw(Canvas canvas, Calendar calendar, int i, int j, int d) {
        ...
        onDrawCurrentDay(canvas, calendar, x, y, calendar.isCurrentDay());
    ...
    protected abstract void onDrawCurrentDay(Canvas canvas, Calendar calendar, int x, int y, boolean isCurrentDay);
}
