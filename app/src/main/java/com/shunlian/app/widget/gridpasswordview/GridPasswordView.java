package com.shunlian.app.widget.gridpasswordview;
...
import com.shunlian.app.widget.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mGridCorner = (int) ta.getDimension(R.styleable.gridPasswordView_gpvGridCorner, 0);
...
//        mOuterLineDrawable = context.getDrawable(R.drawable.bg_zhi_border);
    ...
    private GradientDrawable generateBackgroundDrawable() {
        ...
        drawable.setCornerRadius(mGridCorner);
        return drawable;
    }
