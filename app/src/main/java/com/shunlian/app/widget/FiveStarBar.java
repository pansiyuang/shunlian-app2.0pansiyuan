 ...
 */
public class FiveStarBar extends View {
  ...
  public FiveStarBar(Context context) {
    super(context);
    initView();
  }

  public FiveStarBar(Context context, AttributeSet attrs) {
    super(context, attrs);
    parseAttrs(attrs);
    initView();
  }

  public FiveStarBar(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void parseAttrs(AttributeSet attrs) {
    TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.FiveStarBar);

    borderColor = arr.getColor(R.styleable.FiveStarBar_srb_borderColor, Color.parseColor("#FBD900"));
    fillColor = arr.getColor(R.styleable.FiveStarBar_srb_fillColor, borderColor);
    starBackgroundColor = arr.getColor(R.styleable.FiveStarBar_srb_starBackgroundColor, Color.TRANSPARENT);
    backgroundColor = arr.getColor(R.styleable.FiveStarBar_srb_backgroundColor, Color.TRANSPARENT);

    pressedBorderColor = arr.getColor(R.styleable.FiveStarBar_srb_pressedBorderColor, borderColor);
    pressedFillColor = arr.getColor(R.styleable.FiveStarBar_srb_pressedFillColor, fillColor);
    pressedStarBackgroundColor = arr.getColor(R.styleable.FiveStarBar_srb_pressedStarBackgroundColor, starBackgroundColor);
    pressedBackgroundColor = arr.getColor(R.styleable.FiveStarBar_srb_pressedBackgroundColor, backgroundColor);

    numberOfStars = arr.getInteger(R.styleable.FiveStarBar_srb_numberOfStars, 5);

    starsSeparation = arr.getDimensionPixelSize(R.styleable.FiveStarBar_srb_starsSeparation, (int)valueToPixels(4, Dimension.DP));
    maxStarSize = arr.getDimensionPixelSize(R.styleable.FiveStarBar_srb_maxStarSize, Integer.MAX_VALUE);
    desiredStarSize = arr.getDimensionPixelSize(R.styleable.FiveStarBar_srb_starSize, Integer.MAX_VALUE);
    stepSize = arr.getFloat(R.styleable.FiveStarBar_srb_stepSize, 0.1f);
    starBorderWidth = arr.getFloat(R.styleable.FiveStarBar_srb_starBorderWidth, 5f);
    starCornerRadius = arr.getFloat(R.styleable.FiveStarBar_srb_starCornerRadius, 6f);

    rating = normalizeRating(arr.getFloat(R.styleable.FiveStarBar_srb_rating, 0f));
    isIndicator = arr.getBoolean(R.styleable.FiveStarBar_srb_isIndicator, false);
    drawBorderEnabled = arr.getBoolean(R.styleable.FiveStarBar_srb_drawBorderEnabled, true);
    gravity = Gravity.fromId(arr.getInt(R.styleable.FiveStarBar_srb_gravity, Gravity.Left.id));
  ...
  public boolean onTouchEvent(MotionEvent event) {
    if (!isEnabled() || isIndicator  || (ratingAnimator != null && ratingAnimator.isRunning())) {
      return false;
    }
  ...
  private void animateRating(AnimationBuilder builder) {
    ...
    ratingAnimator.addListener(new AnimatorListener() {
      ...
      public void onAnimationEnd(Animator animator) {
        if (ratingListener != null) {
          ratingListener.onRatingChanged(FiveStarBar.this, rating, false);
        }
      }
  ...
  public interface OnRatingBarChangeListener {
     ...
     */
    void onRatingChanged(FiveStarBar simpleRatingBar, float rating, boolean fromUser);
  ...
  public class AnimationBuilder {
    ...
    private AnimationBuilder(FiveStarBar ratingBar) {
