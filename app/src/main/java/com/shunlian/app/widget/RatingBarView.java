...
public class RatingBarView extends LinearLayout {
    ...
    private ImageView getStarImageView() {
        ...
        int margin = (DeviceInfoUtil.getDeviceWidth(getContext()) - TransformUtil.dip2px(getContext(), 20) - (starCount * Math.round(starImageSize))) / (starCount * 2);
        ...
        layout.setMargins(margin, 0, margin, 0);//设置每颗星星在线性布局的间距
