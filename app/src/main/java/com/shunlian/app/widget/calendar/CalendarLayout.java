...
public class CalendarLayout extends LinearLayout {
    ...
    void updateContentViewTranslateY() {
        ...
        if (mDelegate.getMonthViewShowMode() == CustomCalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            mContentViewTranslateY = Util.getMonthViewHeight(calendar.getYear(), calendar.getMonth(), mItemHeight) - mItemHeight;
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContentView != null && mMonthView != null) {
            int h = getHeight() - mItemHeight - Util.dipToPx(getContext(), 41);
