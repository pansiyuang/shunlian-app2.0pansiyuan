...
public class DayRedWhiteDownTimerView extends ItemCountDownTimerView {

    public DayRedWhiteDownTimerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public DayRedWhiteDownTimerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DayRedWhiteDownTimerView(Context context) {
        super(context);
    }
