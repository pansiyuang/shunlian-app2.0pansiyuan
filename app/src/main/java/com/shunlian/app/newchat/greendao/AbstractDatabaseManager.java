...
import com.shunlian.app.newchat.entity.DaoSession;
...
public abstract class AbstractDatabaseManager<M, K> implements IDatabase<M, K> {
    ...
    private static final String DEFAULT_DATABASE_NAME = "MessageInfo.db";
    /**
     ...
     * @param dataBaseName
     */
    public static void initOpenHelper(Context context, String dataBaseName) {
     ...
     */
    private static DaoMaster.DevOpenHelper getOpenHelper(Context context, @Nullable String dataBaseName) {
        closeDbConnections();
