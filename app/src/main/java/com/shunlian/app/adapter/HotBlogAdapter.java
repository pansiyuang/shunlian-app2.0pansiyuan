...
//        int height = display.getHeight();
        ...
        miv_icon.setOnClickListener(v -> MyPageActivity.startAct(context, blog.member_id));
        GlideUtils.getInstance().loadCircleAvar(context, miv_icon, blog.avatar);
        SpannableStringBuilder ssb = Common.changeColor(blog.nickname + getString(R.string.discover_fenxiangdetuijian), blog.nickname, getColor(R.color.value_007AFF));
