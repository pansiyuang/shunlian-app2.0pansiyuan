...
public class ShangAdapter extends BaseRecyclerAdapter<PersonalcenterEntity.OursSchool.Item> {


    public ShangAdapter(Context context, boolean isShowFooter, List<PersonalcenterEntity.OursSchool.Item> lists) {
    ...
    public void handleList(RecyclerView.ViewHolder holder, int position) {
        ...
        PersonalcenterEntity.OursSchool.Item ad = lists.get(position);
