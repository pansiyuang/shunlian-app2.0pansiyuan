...
import com.shunlian.app.utils.GroupStructure;
 ...
 */
public abstract class GroupedRecyclerViewAdapter extends RecyclerView.Adapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(BaseRecyclerAdapter.BaseRecyclerViewHolder holder) {
    ...
    @Override
    public void onBindViewHolder(final BaseRecyclerAdapter.BaseRecyclerViewHolder holder, int position) {
    ...
    public abstract void onBindHeaderViewHolder(BaseRecyclerAdapter.BaseRecyclerViewHolder holder, int groupPosition);

    public abstract void onBindFooterViewHolder(BaseRecyclerAdapter.BaseRecyclerViewHolder holder, int groupPosition);

    public abstract void onBindChildViewHolder(BaseRecyclerAdapter.BaseRecyclerViewHolder holder,
    ...
    public interface OnHeaderClickListener {
        void onHeaderClick(GroupedRecyclerViewAdapter adapter, BaseRecyclerAdapter.BaseRecyclerViewHolder holder, int groupPosition);
    }

    public interface OnFooterClickListener {
        void onFooterClick(GroupedRecyclerViewAdapter adapter, BaseRecyclerAdapter.BaseRecyclerViewHolder holder, int groupPosition);
    }

    public interface OnChildClickListener {
        void onChildClick(GroupedRecyclerViewAdapter adapter, BaseRecyclerAdapter.BaseRecyclerViewHolder holder,
                          int groupPosition, int childPosition);
    }
}