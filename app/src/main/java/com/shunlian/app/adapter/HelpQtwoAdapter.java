...
public class HelpQtwoAdapter extends BaseRecyclerAdapter<HelpcenterIndexEntity.QuestionCommon> {

    public HelpQtwoAdapter(Context context, boolean isShowFooter, List<HelpcenterIndexEntity.QuestionCommon> lists) {
    ...
    public void handleList(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HolderView) {
            ...
            HelpcenterIndexEntity.QuestionCommon category = lists.get(position);
