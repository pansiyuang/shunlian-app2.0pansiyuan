...
public class OpinionAdapter extends BaseAdapter {
    ...
    public OpinionAdapter(Context context, List<ImageEntity> data) {
    ...
    @Override
    public int getCount() {
        return pics.size()==0?1:pics.size()+1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        OpinionAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_single_img, viewGroup, false);
            viewHolder = new OpinionAdapter.ViewHolder(convertView);
