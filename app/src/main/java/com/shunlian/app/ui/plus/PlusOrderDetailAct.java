...
import com.shunlian.app.presenter.PlusOrderDetailPresenter;
...
public class PlusOrderDetailAct extends BaseActivity implements View.OnClickListener, IPlusOrderdetailView, MessageCountManager.OnGetMessageListener {
...
//    MyRelativeLayout mrlayout_cuxiao;
    ...
    @BindView(R.id.mllayout_operate)
    MyLinearLayout mllayout_operate;
...
//    MyLinearLayout mllayout_time;
    ...
    private PlusOrderDetailPresenter plusOrderDetailPresenter;
    private String storeId, plus_order_id = "";
...
//    private boolean isTimerCount = false;
    ...
    public static void startAct(Context context, String plus_order_id) {
        Intent intent = new Intent(context, PlusOrderDetailAct.class);
        intent.putExtra("plus_order_id", plus_order_id);
    ...
    protected void onRestart() {
        super.onRestart();
        if (plusOrderDetailPresenter != null) {
            plusOrderDetailPresenter.initApiData();
        }
    }

    @Override
    protected int getLayoutId() {
        return R.layout.act_plus_order_detail;
    }
    ...
    protected void initData() {
        ...
        if (!TextUtils.isEmpty(getIntent().getStringExtra("plus_order_id"))) {
            plus_order_id = getIntent().getStringExtra("plus_order_id");
        }
        //设置圆角背景
...
//        pink_color = getColorResouce(R.color.pink_color);
        ...
        plusOrderDetailPresenter = new PlusOrderDetailPresenter(this, this, plus_order_id);
...
//        mtv_title4.setVisibility(View.GONE);
        mllayout_operate.setVisibility(View.GONE);
...
//                mtv_title3.setVisibility(View.GONE);
                break;
            case "2":
                mllayout_operate.setVisibility(View.VISIBLE);
...
//                }
                ...
                t1Dackground.setStroke(strokeWidth, new_gray);
                mtv_title1.setTextColor(new_gray);
                mtv_title1.setText(getString(R.string.order_wuliu));
