...
public class DemoSingleImgAdapter extends BaseAdapter{
    ...
    public DemoSingleImgAdapter(Context context, List<ImageEntity> data) {
        mContext=context;
        pics=data;
    ...
    @Override
    public int getCount() {
        return pics==null?1:pics.size()+1;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        DemoSingleImgAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_single_img, parent, false);
            viewHolder = new DemoSingleImgAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (DemoSingleImgAdapter.ViewHolder) convertView.getTag();
        }
