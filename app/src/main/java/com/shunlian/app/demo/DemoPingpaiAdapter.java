...
public class DemoPingpaiAdapter extends BaseRecyclerAdapter<CorePingEntity.MData> {
    private int second=(int)(System.currentTimeMillis()/1000);
    public DemoPingpaiAdapter(Context context, boolean isShowFooter, List<CorePingEntity.MData> lists) {
    ...
    protected RecyclerView.ViewHolder getRecyclerHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_ping_pai, parent, false);

        return new ActivityMoreHolder(inflate);
    }
    ...
    public class ActivityMoreHolder extends BaseRecyclerViewHolder implements View.OnClickListener {
        ...
        public ActivityMoreHolder(View itemView) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(picWidth, picWidth*158 /340);
            params.setMargins(TransformUtil.dip2px(context, 10),TransformUtil.dip2px(context, 15),TransformUtil.dip2px(context, 10),0);
            mrlayout_root.setLayoutParams(params);
